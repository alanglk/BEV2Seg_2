...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \fill[\covercolor] (current page.north west) ++ (0,-3.01cm) rectangle (\paperwidth,-3cm);
    \end{tikzpicture}
    ...
    % Estudiante
    \vspace{0.2cm}
    \noindent {\footnotesize \textbf{Student:} \student}
    \newline
    ...
    \vspace{0.3cm}
    \nopagebreak
    \noindent {\footnotesize \textbf{Industrial Consultant:} \codirector }
    \newline
    \noindent {\footnotesize \textbf{Supervisors:} \director }
    ...
    % Curso y Fecha
    \vspace{0.1cm}    
    \noindent {\footnotesize \textbf{Academic Year: } \curso \hfill \textbf{Date:} \today }
\end{titlepage}
