...
\subparagraph*{Evaluation Methodology and Overall Performance}
...
\subparagraph*{Dimensional Accuracy Assessment}
...
\subparagraph*{Case Studies on Dimensional Estimation}
...
\subparagraph*{Parked Truck (ID 41)}
...
\subparagraph*{Leading Van (ID 154)}
...
\subparagraph*{Stationary Excavator (ID 129)}
...
\subparagraph*{Bounding Box Disparity (BBD) Analysis}
