...
\begin{table}[h!]
    ...
    \hline
    Straight & 1.608 & 0.462 & 0.424 \\
    \hline
    Turning & 1.081 & 0.385 & 0.379 \\
    \hline
    Straight & 0.368 & 0.144 & 0.027 \\
    \hline
    \end{tabular}
    \caption{Turning with 5 deg}
    \label{tab:cgrsdfgresfg}
\end{table}
...
\begin{table}[h!]
    ...
    \hline
    \end{tabular}
    \caption{Custom turning frames}
    \label{tab:sdklhflkjsad}
\end{table}
