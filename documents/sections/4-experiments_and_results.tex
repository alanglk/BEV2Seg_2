...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\linewidth]{./images/experiments/raw2segbev_mit-b0_v0.2_new_test_evaluation.png}
...
\begin{table}[ht]
    ...
    \midrule
    background & background & 0.97 & \textbf{0.97} & 0.99 & \textbf{0.99} \\
    \midrule
    animal & animal & 0.00 & 0.00 & 0.00 & 0.00 \\
    \midrule
    human.pedestrian.adult & human.pedestrian.adult & 0.07 & \textbf{0.08} & 0.09 & \textbf{0.11} \\
    ...
    \midrule
    movable\_object.barrier & movable\_object.barrier & 0.08 & \textbf{0.14} & 0.09 & \textbf{0.17} \\
    ...
    vehicle.car & vehicle.bus.bendy & 0.00 & - & 0.00 & - \\
     ...
     & vehicle.car & 0.30 & \textbf{0.38} & 0.33 & \textbf{0.42} \\
    ...
    vehicle.motorcycle & vehicle.bicycle & 0.02 & - & 0.02 & - \\
     & vehicle.motorcycle & 0.04 & \textbf{0.06} & 0.05 & \textbf{0.07} \\
    \midrule
    flat.driveable\_surface & flat.driveable\_surface & 0.94 & \textbf{0.94} & 0.97 & \textbf{0.97} \\
    \bottomrule
     & & 0.10 & \textbf{0.32} & 0.11 & \textbf{0.34} \\
    \bottomrule
    \end{tabular}
    \caption{Per-class metric comparison between Model A and merged Model B evaluated with BEV images. Last row shows the mean IoU and mean F1 scores along all semantic classes of each model.}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{./images/experiments/nor_before_after_data_aug_logs.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{./images/experiments/bev_before_after_data_aug_logs.png}
...
\begin{table}[!ht]
    ...
    \caption{Comparison of mIoU scores across models. Bold values indicate the best-performing model for each semantic class.}
