...
\usepackage{threeparttable}             % Para el entorno tablenotes
\usepackage{makecell}                   % Útil para forzar saltos de línea en celdas y \thead
...
\usepackage[toc,page]{appendix}         % Apéndice
...
\newcommand{\director}{ Dr. Barrena Orueechebarria, Nagore; Dr. Elordi Hidalgo, Unai}
\newcommand{\codirector}{Sánchez Juanola, Martí}
\newcommand{\master}{MASTER'S DEGREE IN COMPUTATIONAL ENGINEERING AND INTELLIGENT SYSTEMS}
\newcommand{\titulo}{BEV2SEG\_2: ANALYSIS OF SEMANTIC SEGMENTATION OF PLANAR ELEMENTS IN BIRD’S-EYE-VIEW AND ITS APPLICATIONS TO AUTOMATED
SCENE PRE-ANNOTATION

}
\newcommand{\covercolor}{palette_blue_1}
\newcommand{\portada}{images/shared/raw_cuboids.png}
\newcommand{\curso}{2024-2025}


% Definición de Macros
\newcommand*{\fullref}[1]{\hyperref[{#1}]{\autoref*{#1} \nameref*{#1}}} % One single link
\newcommand{\objref}[1]{\hyperref[fig:objectives]{\textbf{#1}}}
...
\input{sections/4-experiments_and_results.tex}
\clearpage
